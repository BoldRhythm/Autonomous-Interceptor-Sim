  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: traffic_avoidance_unhealthy
  {
    cdr << (ros_message->traffic_avoidance_unhealthy ? true : false);
  }
  ...
  // Field name: gnss_lost
  {
    cdr << (ros_message->gnss_lost ? true : false);
  }
  ...
  px4_msgs__msg__FailsafeFlags * ros_message)
{
  ...
  // Field name: traffic_avoidance_unhealthy
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->traffic_avoidance_unhealthy = tmp ? true : false;
  }
  ...
  // Field name: gnss_lost
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->gnss_lost = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: traffic_avoidance_unhealthy
  {
    size_t item_size = sizeof(ros_message->traffic_avoidance_unhealthy);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: gnss_lost
  {
    size_t item_size = sizeof(ros_message->gnss_lost);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
